...
<div class="p-a white lt box-shadow">
	<div class="row">
		<div class="col-sm-6">
			<h4 class="m-b-0 _300">Edit Position</h4>
		</div>
	</div>
</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Position" name="name" id="name" onkeyup="cekPosition();" required value="<?php echo $row->name;?>">
									</div>
								</div>
							</div>
						</div>			
