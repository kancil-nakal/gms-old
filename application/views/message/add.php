...
<div class="p-a white lt box-shadow">
	<div class="row">
		<div class="col-sm-6">
			<h4 class="m-b-0 _300">New Message</h4>
		</div>
	</div>
</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="Enter Message Name" name="message_name" id="message_name" required>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group row">
								...
								<div class="col-sm-1">
									<input type="radio" class="recipient" name="recipient" value="all" checked> All
								</div>
								<div class="col-sm-1">	
									<input type="radio" class="recipient" name="recipient" value="client"> Client: 
								</div>
								<div class="col-sm-4">	
								...
								<div class="col-sm-1">	
									<input type="radio" class="recipient" name="recipient" value="team"> Team: 
								</div>
								<div class="col-sm-4">	
									<div class="input-group">
										<input type="text" class="form-control" id="team_name" value="" disabled>
										<span class="input-group-btn">
...
function listTeamName() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{ field: 'position', title: 'No Polisi', align: 'left' },
