...
<div class="p-a white lt box-shadow">
	<div class="row">
		<div class="col-sm-6">
			<h4 class="m-b-0 _300">Edit Attendance</h4>
		</div>
	</div>
</div>
						...
						<div class="row">
                                    ...
                                    <div class="col-sm-5">
										<select class="form-control" name="att_type" id="att_type">
											...
											for($i=0;$i<count($getAttType);$i++) {
												if ($getAttType[$i]['id'] == $row->att_type) {
													$select = 'selected="selected"';
												} else {
													$select = '';
												}
												?>
												<option <?php echo $select;?> value="<?php echo $getAttType[$i]['id']; ?>"><?php echo $getAttType[$i]['name']; ?></option>
												<?php
											}
											?>
										</select>
							...
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-11">
										<textarea name="att_reason" class="form-control" rows="4"><?php echo $row->att_reason; ?></textarea>
                                    </div>
								</div> 
							</div>
						</div>			
