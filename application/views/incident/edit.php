...
<div class="p-a white lt box-shadow">
	<div class="row">
		<div class="col-sm-6">
			<h4 class="m-b-0 _300">Edit Incident</h4>
		</div>
	</div>
</div>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Incident No" name="incident_no" value="<?php echo $row->incident_no; ?>">
                                    </div>
                                    ...
                                    <div class="col-sm-5">
										<select class="form-control" name="status" id="status">
											...
											for($i=0;$i<count($getStatus);$i++) {
												if ($getStatus[$i]['id'] == $row->status) {
													$select = 'selected="selected"';
												} else {
													$select = '';
												}
												?>
												<option <?php echo $select;?> value="<?php echo $getStatus[$i]['id']; ?>"><?php echo $getStatus[$i]['name']; ?></option>
												<?php
											}
											?>
										</select>
							...
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Subject" name="subject" value="<?php echo $row->subject; ?>">
                                    </div>
									<label class="col-sm-1 form-control-label"><b>Date</b></label>
                                    <div class="col-sm-2" id="sandbox-container">
                                        <div class="input-group date datepicker">
                                            <input type="text" class="form-control" placeholder="Enter Incident Date" name="incident_date" value="<?php echo $row->incident_date; ?>">
                                            <span class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-sm-2">
										<input type="text" class="form-control" placeholder="Enter Incident Time" name="incident_time" value="<?php echo $row->incident_time; ?>">
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" placeholder="Enter Location" name="location" value="<?php echo $row->location; ?>">
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
										<textarea name="parties"><?php echo $row->parties; ?></textarea>
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
							...
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
										<textarea name="action"><?php echo $row->action; ?></textarea>
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
										<textarea name="analysis"><?php echo $row->analysis; ?></textarea>
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
										<textarea name="advice"><?php echo $row->advice; ?></textarea>
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <img src="http://gmsapi.mesinrusak.com/uploads/<?php echo $file->file_name; ?>.jpg" width="400px">&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('incident'); ?>/del_file/<?php echo $row->id; ?>/<?php echo $file->id; ?>">[X]</a><br/>
                                    <?php } } ?>
                                    </div>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Modified Alias" name="modified_by" value="<?php echo $row->modified_by; ?>">
                                    </div>
									<label class="col-sm-2 form-control-label"><b>Modified Position</b></label>
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Modified Position" name="modified_position" value="<?php echo $row->modified_position; ?>">
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Modified Alias" name="modified_alias" value="<?php echo $row->modified_alias; ?>">
                                    </div>
									<label class="col-sm-2 form-control-label"><b>Modified Department</b></label>
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Modified Department" name="modified_department" value="<?php echo $row->modified_department; ?>">
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Knowing By" name="knowing_by" value="<?php echo $row->knowing_by; ?>">
                                    </div>
									<label class="col-sm-2 form-control-label"><b>Knowing Position</b></label>
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Knowing Position" name="knowing_position" value="<?php echo $row->knowing_position; ?>">
                                    </div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Accepted By" name="accepted_by" value="<?php echo $row->accepted_by; ?>">
                                    </div>
									<label class="col-sm-2 form-control-label"><b>Accepted Position</b></label>
                                    <div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Enter Accepted Position" name="accepted_position" value="<?php echo $row->accepted_position; ?>">
                                    </div>
								</div>
							</div>
						</div>			
