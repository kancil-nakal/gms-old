...
<div class="p-a white lt box-shadow">
	<div class="row">
		<div class="col-sm-6">
			<h4 class="m-b-0 _300">Edit Banner</h4>
		</div>
	</div>
</div>
...
<div class="padding">
	<div class="row">
		<form action="<?php echo base_url('iklan/edit'); ?>" method="post" enctype="multipart/form-data">
			<div class="box">
				<div class="box-body">
							...
							<div class="col-sm-12">
								<div class="form-group row">
									...
									<label class="col-sm-10">
										...
										if( $row->images != '' ) {
											?>
											<img id="thumbnil" style="width:200px;height:200px;" src="<?php echo base_url().$row->images; ?>" alt="image"/>
											<?php
										} else {
											?>
											<img id="thumbnil" style="width:200px;height:200px;" src="<?php echo base_url(); ?>assets/images/no-image.jpg" alt="image"/>
											<?php
										}
										?>
									</label>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" class="form-control" id="client_name" value="<?php echo $row->ta_name;?>" disabled>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<textarea name="message"><?php echo $row->description;?></textarea>
									</div>
								</div>
							</div>
						</div>
