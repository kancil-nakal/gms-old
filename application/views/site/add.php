...
<div class="p-a white lt box-shadow">
	<div class="row">
		<div class="col-sm-6">
			<h4 class="m-b-0 _300">New Site</h4>
		</div>
	</div>
</div>
...
<div class="padding">
	<div class="row">
		<form action="<?php echo base_url('site/save'); ?>" method="post" enctype="multipart/form-data">
			<div class="box">
				<div class="box-body">
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="Enter Site Name" name="site_name" id="site_name" required>
								</div>
							</div>
						</div>
                        <div class="col-sm-6">
