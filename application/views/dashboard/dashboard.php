        ...
        <div class="col-md-6 cols-sm-12">
            <div class="box p-a">
                ...
                <div class="clear">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6 text-md _600">Client</div>
...
/*
		<div class="col-md-6 col-sm-12">
			<div class="box p-a">
				<div style="border-bottom: 1px solid rgba(120, 130, 140, 0.13); padding-bottom: 15px;">
					<div class="pull-left m-r">
						<i class="fa fa-car text-2x m-y-sm"></i>
					</div>
					<div class="clear">
						<h4 class="m-a-0 text-md _600" style="padding-top: 10px;">Driver Terbaik per tanggal <?php echo date('d M Y', mktime(0, 0, 0, date('m'), date('d') - 1, date('Y') )); ?></h4>
					</div>
				</div>
				<div class="list-item" style="padding-left: 0px; padding-right: 0px;">
					<div class="list-body">
						<?php foreach ($bestDriver as $row) { ?>
							<a class="_500" style="cursor: none;"><?php echo $row->member_name;?></a>
							<small class="block text-muted">
								<div class="col-md-3" style="padding-left: 0;">
									<i class="fa fa-cab"></i> Total KM
								</div>
								<div class="col-md-9">: <?php echo $row->total_km;?> KM</div>
							</small>
							<small class="block text-muted">
								<div class="col-md-3" style="padding-left: 0;">
									<i class="fa fa-eye"></i> Total Viewer
								</div>
								<div class="col-md-9">: <?php echo $row->total_viewer;?></div>
							</small>
							<small class="block text-muted">
								<div class="col-md-3" style="padding-left: 0;">
									<i class="fa fa-money"></i> Total Dana
								</div>
								<div class="col-md-9">: <?php echo $row->dana_driver;?></div>
							</small>
						<?php } ?>
					</div>
				</div>
		...
		<div class="col-md-6 col-sm-12">
			<div class="box p-a">
				<div style="border-bottom: 1px solid rgba(120, 130, 140, 0.13); padding-bottom: 15px;">
					...
					<div class="clear">
						<h4 class="m-a-0 text-md _600" style="padding-top: 10px;">Driver Terendah per tanggal <?php echo date('d M Y', mktime(0, 0, 0, date('m'), date('d') - 1, date('Y') )); ?></h4>
					</div>
				</div>
				<div class="list-item" style="padding-left: 0px; padding-right: 0px;">
					<div class="list-body">
						<?php foreach ($worstDriver as $row) { ?>
							<a class="_500" style="cursor: none;"><?php echo $row->member_name;?></a>
							<small class="block text-muted">
								<div class="col-md-3" style="padding-left: 0;">
									<i class="fa fa-cab"></i> Total KM
