...
<div class="p-a white lt box-shadow">
	<div class="row">
		<div class="col-sm-6">
			<h4 class="m-b-0 _300">New Patrol</h4>
		</div>
	</div>
</div>
...
<div class="padding">
<div class="row">
        <form action="<?php echo base_url('checkpoint/save'); ?>" method="post">
            <div class="box">
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4" id="sandbox-container">
                                    <div class="input-group date datepicker">
                                        <input type="text" class="form-control" placeholder="Enter Join Date" name="att_date" value="<?php echo date('Y-m-d'); ?>">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label"><b>Total Checkpoint</b></label>
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" placeholder="Enter Total Checkpoint" name="total" value="">
                                </div>
                            </div>
                        </div>
                    </div>			
                ...
                <div class="dker p-a text-left">
                    ...
                    <a href="<?php echo base_url('checkpoint'); ?>" class="btn btn-fw danger">Cancel</a>
                </div>
            </div>
        </form>
	</div>
