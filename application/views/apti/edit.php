...
<?php foreach ($getData as $row) { ?>
	<div class="p-a white lt box-shadow">
		<div class="row">
			<div class="col-sm-6">
				<h4 class="m-b-0 _300">Edit APTI</h4>
			</div>
		</div>
	</div>
	...
	<div class="padding">
		<div class="row">
			<form action="<?php echo base_url('apti/edit'); ?>" method="post" enctype="multipart/form-data">
				<div class="box">
					<div class="box-body">
						<div class="row">
							<div class="col-sm-5">
					...
					<div class="dker p-a text-left">
						...
						<a href="<?php echo base_url('apti'); ?>" class="btn btn-fw danger">Cancel</a>
					</div>
				</div>
			</form>
		</div>
