...
<div class="p-a white lt box-shadow">
	<div class="row">
		<div class="col-sm-6">
			<h4 class="m-b-0 _300">Edit Team</h4>
		</div>
	</div>
</div>
...
<div class="padding">
	<div class="row">
		...
		?>
			<form action="<?php echo base_url('team/edit'); ?>" method="post" enctype="multipart/form-data">
				<div class="box">
					<div class="box-body">
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group row">
									...
									if( $row->avatar != '' ) {
										?>
										<label class="col-sm-3"><img id="thumbnil" style="width:100px;height:100px;" src="<?php echo base_url().$row->avatar ;?>" alt="image"/></label>
										<?php
									} else {
										?>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" placeholder="Enter Name" name="team_name" value="<?php echo $row->team_name; ?>">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-3 form-control-label"><b>Mobile Phone</b></label>
									<div class="col-sm-9">
										<input type="text" class="form-control" placeholder="Enter Mobile Phone" name="mobile_phone" value="<?php echo $row->mobile_phone; ?>">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<select class="form-control" name="position_id" id="position_id">
											...
											for($i=0;$i<count($getPosition);$i++) {
												if ($getPosition[$i]['id'] == $row->position_id) {
													$select = 'selected="selected"';
												} else {
													$select = '';
												}
												?>
												<option <?php echo $select;?> value="<?php echo $getPosition[$i]['id']; ?>"><?php echo $getPosition[$i]['name']; ?></option>
												<?php
											}
											?>
										</select>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-9" id="sandbox-container">
                                        <div class="input-group date datepicker">
                                            <input type="text" class="form-control" placeholder="Enter Join Date" name="join_date" value="<?php echo $row->join_date; ?>">
								...
								<div class="form-group row">
									...
									<div class="input-group col-sm-9">
										<div class="switch-toggle switch-2 well" style="margin-bottom:0px !important">
											<?php if($row->team_status == 0) { ?>
												<input id="team_status_y" name="team_status" type="radio" checked value="0">
												<label for="team_status_y" onclick="">Enable</label>
												<input id="team_status_n" name="team_status" type="radio" value="1">
												<label for="team_status_n" onclick="">Disable</label>
												<a class="btn btn-primary"></a>
											<?php } else { ?>
												<input id="team_status_y" name="team_status" type="radio" value="0">
												<label for="team_status_y" onclick="">Enable</label>
												<input id="team_status_n" name="team_status" type="radio" checked value="1">
												<label for="team_status_n" onclick="">Disable</label>
												<a class="btn btn-primary"></a>
											<?php } ?>
										</div>
									...
									<div class="input-group col-sm-9">
										<div class="switch-toggle switch-2 well" style="margin-bottom:0px !important">
											<?php if($row->app_status == 0) { ?>
												<input id="app_status_y" name="app_status" type="radio" checked value="0">
												<label for="app_status_y" onclick="">Enable</label>
												<input id="app_status_n" name="app_status" type="radio" value="1">
												<label for="app_status_n" onclick="">Disable</label>
												<a class="btn btn-primary"></a>
											<?php } else { ?>
												<input id="app_status_y" name="app_status" type="radio" value="0">
												<label for="app_status_y" onclick="">Enable</label>
												<input id="app_status_n" name="app_status" type="radio" checked value="1">
												<label for="app_status_n" onclick="">Disable</label>
												<a class="btn btn-primary"></a>
											<?php } ?>
										</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group row">
									...
									<div class="col-sm-12">
										<textarea class="form-control" name="education"><?php echo $row->education; ?></textarea>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-12 form-control-label"><b>Experience</b></label>
									<div class="col-sm-12">
										<textarea class="form-control" name="experience"><?php echo $row->experience; ?></textarea>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-12 form-control-label"><b>Training</b></label>
									<div class="col-sm-12">
										<textarea class="form-control" name="training"><?php echo $row->training; ?></textarea>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-12 form-control-label"><b>Certificate</b></label>
                                <?php if(count((array)json_decode($row->certificate)) > 0) { ?>
									<div class="col-sm-12">
                                        <ul>
                                <?php foreach(json_decode($row->certificate) as $cert) { ?>
                                        <li><a href="<?php echo base_url(); ?>public/uploads/<?php echo $cert; ?>" target="_blank" style="text-decoration: underline;"><?php echo $cert; ?></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('team'); ?>/del_cert/<?php echo $row->id; ?>/<?php echo $cert; ?>">[x]</a></li>
                                <?php } ?>
                                        </ul>
									</div>
                                <?php } ?>
