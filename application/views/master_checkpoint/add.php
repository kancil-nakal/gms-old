                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" placeholder="Enter Checkpoint" name="name" id="name" onkeyup="cekCheckpoint();" required value="">
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-1">
                                    <input type="number" class="form-control" name="ordering" id="ordering" required value="">
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="beacon_id" id="beacon_id">
                                        ...
                                        for($i=0;$i<count($getBeacon);$i++) {
                                            ?>
                                            <option value="<?php echo $getBeacon[$i]['id']; ?>"><?php echo $getBeacon[$i]['notes']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
